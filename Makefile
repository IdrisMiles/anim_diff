...
DISTDIR = /home/idris/uni/collab/Collab/obj/qtOpenGL1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/idris/Qt5.7.0/5.7/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/local/lib -L/usr/lib -lGLU -lGLEW -L${HOME}/dev/lib -lassimp -L/home/idris/Qt5.7.0/5.7/gcc_64/lib -lQt5OpenGL -L/usr/lib64 -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
